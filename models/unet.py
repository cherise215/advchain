...
class UNet(nn.Module):
    def __init__(self, input_channel, num_classes,feature_scale=1,encoder_dropout=None, decoder_dropout=None,norm=nn.BatchNorm2d,self_attention=False,if_SN=False,last_layer_act=None):
        ...
        self.up1 = up(512//feature_scale, 512//feature_scale, 256//feature_scale, norm=norm, dropout=decoder_dropout,if_SN=if_SN)
        self.up2 = up(256//feature_scale, 256//feature_scale, 128//feature_scale, norm=norm, dropout=decoder_dropout,if_SN=if_SN)
        self.up3 = up(128//feature_scale, 128//feature_scale, 64//feature_scale, norm=norm, dropout=decoder_dropout,if_SN=if_SN)
        self.up4 = up(64//feature_scale, 64//feature_scale, 64//feature_scale, norm=norm, dropout=decoder_dropout,if_SN=if_SN)
        if self_attention:
...
class DeeplySupervisedUNet(nn.Module):
    def __init__(self, input_channel, num_classes,base_n_filters=64,dropout=None,activation=nn.ReLU):
        ...
        self.up1 = up(base_n_filters*8, base_n_filters*8, base_n_filters*4,activation=activation,dropout=dropout)
        self.up2 = up(base_n_filters*4, base_n_filters*4, base_n_filters*2,activation=activation,dropout=dropout)
...
class UNetv2(nn.Module):
    def __init__(self, input_channel, num_classes,feature_scale=1,encoder_dropout=None, decoder_dropout=None,norm=nn.BatchNorm2d,self_attention=False,if_SN=False,last_layer_act=None):
        ...
        self.up1 = up(1024//feature_scale, 512//feature_scale, 256//feature_scale, norm=norm, dropout=decoder_dropout,if_SN=if_SN)
        self.up2 = up(256//feature_scale, 256//feature_scale, 128//feature_scale, norm=norm, dropout=decoder_dropout,if_SN=if_SN)
        self.up3 = up(128//feature_scale, 128//feature_scale, 64//feature_scale, norm=norm, dropout=decoder_dropout,if_SN=if_SN)
        self.up4 = up(64//feature_scale, 64//feature_scale, 64//feature_scale, norm=norm, dropout=decoder_dropout,if_SN=if_SN)
        if self_attention:
